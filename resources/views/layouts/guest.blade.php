...
<head>
    ...
    <title>@yield('title', config('app.name', 'RW 012'))</title>
    ...
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            <a href="{{ route('home') }}" class="inline-flex items-center gap-3">
                <img src="{{ asset('images/hero/logo_puri.png') }}" alt="Logo Puri Agung Permai RW12" class="w-12 h-12 object-contain">
        ...
        <p class="text-center mt-6 text-sm text-white/60">&copy; {{ date('Y') }} Puri Agung Permai RW12. All rights reserved.</p>
    </div>
