            ...
            <div class="max-w-7xl mx-auto px-4">
                <div class="flex justify-between items-center gap-6 h-20 lg:h-24">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <a href="https://wa.me/6281943672268" target="_blank" rel="noopener noreferrer" class="hidden xl:inline-flex items-center gap-2 bg-rose-600 text-white px-5 py-2.5 rounded-lg text-sm font-semibold hover:bg-rose-700 transition-all shadow-sm">
    ...
    <footer class="bg-white border-t border-slate-200 mt-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li>
                            <a href="https://youtube.com/@puriagungrw012?si=VoEGAr9Ipt3gink3" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2.5 text-slate-500 hover:text-rose-600 transition-colors">
                        ...
                        <li>
                            <a href="https://www.instagram.com/puriagungpermai/" target="_blank" rel="noopener noreferrer" class="flex items-center gap-2.5 text-slate-500 hover:text-rose-600 transition-colors">
        ...
        <div class="border-t border-slate-100">
            <div class="max-w-7xl mx-auto px-4 py-6 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-400">
                ...
                <a href="https://wa.me/6281943672268" target="_blank" rel="noopener noreferrer" class="hover:text-rose-600 transition-colors">Hubungi Kami</a>
            </div>
        </div>
    </footer>

    <!-- Floating WhatsApp -->
    <a href="https://wa.me/6281943672268" target="_blank" rel="noopener noreferrer" class="wa-float fixed bottom-6 right-6 z-50 w-14 h-14 bg-green-500 rounded-full flex items-center justify-center shadow-lg hover:bg-green-600 hover:shadow-xl hover:-translate-y-1 transition-all duration-300" title="Hubungi RW12 via WhatsApp">
