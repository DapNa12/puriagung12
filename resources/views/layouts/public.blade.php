...
<body class="bg-slate-50 min-h-screen flex flex-col selection:bg-rose-200 selection:text-rose-900">
    ...
    <div class="bg-slate-900 text-slate-300 text-xs hidden md:block">
        <div class="max-w-7xl mx-auto px-4 py-2 flex justify-between items-center">
            <div class="flex items-center gap-5">
                <a href="tel:0895611487628" class="hover:text-white transition-colors flex items-center gap-1.5">
                    <i data-lucide="phone" class="w-3.5 h-3.5"></i>
                    0895-6114-8762
                </a>
                <a href="mailto:info@rwdusun.id" class="hover:text-white transition-colors flex items-center gap-1.5">
                    <i data-lucide="mail" class="w-3.5 h-3.5"></i>
                    info@rwdusun.id
                </a>
            </div>
            <div class="flex items-center gap-2">
                <a href="https://youtube.com/@puriagungpermai" target="_blank" rel="noopener noreferrer" class="w-7 h-7 rounded-md flex items-center justify-center hover:bg-slate-800 hover:text-white transition-all" title="YouTube">
                    <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.546 12 3.546 12 3.546s-7.505 0-9.377.504A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.504 9.376.504 9.376.504s7.505 0 9.377-.504a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                </a>
                <a href="https://tiktok.com/@puriagungpermai" target="_blank" rel="noopener noreferrer" class="w-7 h-7 rounded-md flex items-center justify-center hover:bg-slate-800 hover:text-white transition-all" title="TikTok">
                ...
                <a href="https://instagram.com/puriagungpermai" target="_blank" rel="noopener noreferrer" class="w-7 h-7 rounded-md flex items-center justify-center hover:bg-slate-800 hover:text-white transition-all" title="Instagram">
