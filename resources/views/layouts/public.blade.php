        ...
        <div class="max-w-7xl mx-auto px-4 py-12">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                <div>
                    ...
                    <div class="flex items-center gap-3">
                        <a href="https://youtube.com/@puriagungpermai" target="_blank" rel="noopener noreferrer" class="w-9 h-9 bg-slate-100 hover:bg-rose-50 rounded-lg flex items-center justify-center text-slate-400 hover:text-rose-600 transition-all" title="YouTube">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.546 12 3.546 12 3.546s-7.505 0-9.377.504A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.504 9.376.504 9.376.504s7.505 0 9.377-.504a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                        </a>
                        <a href="https://tiktok.com/@puriagungpermai" target="_blank" rel="noopener noreferrer" class="w-9 h-9 bg-slate-100 hover:bg-rose-50 rounded-lg flex items-center justify-center text-slate-400 hover:text-rose-600 transition-all" title="TikTok">
                        ...
                        <a href="https://instagram.com/puriagungpermai" target="_blank" rel="noopener noreferrer" class="w-9 h-9 bg-slate-100 hover:bg-rose-50 rounded-lg flex items-center justify-center text-slate-400 hover:text-rose-600 transition-all" title="Instagram">
