...
@section('title', 'Pengurus RT')
@section('meta_description', 'Daftar pengurus RT di Puri Agung Permai RW12. Struktur kepengurusan RT setiap blok.')
@section('og_title', 'Pengurus RT - Puri Agung Permai RW12')
@section('og_description', 'Daftar pengurus RT di Puri Agung Permai RW12.')
    ...
    <div class="max-w-7xl mx-auto px-4 py-12 md:py-16">
        <div class="max-w-3xl">
            ...
            <p class="mt-3 text-slate-600 text-base md:text-lg">
                Struktur kepengurusan RT{{ $tahunMulai ? ' masa bakti ' . $tahunMulai . ' - ' . ($tahunSelesai ?: 'Sekarang') : '' }}
            </p>
        </div>
    </div>
</div>
...
<div class="max-w-7xl mx-auto px-4 py-8 md:py-14">
    ...
    @else
        @foreach($grouped as $rt => $pengurus)
        <div class="mb-12 md:mb-14">
            <div class="flex items-center gap-4 mb-6 md:mb-8">
                <div class="flex-1 h-px bg-slate-200"></div>
                <span class="px-4 py-1.5 rounded-full bg-rose-600 text-white text-sm font-bold shadow-sm">RT {{ $rt }}</span>
                <div class="flex-1 h-px bg-slate-200"></div>
            </div>
