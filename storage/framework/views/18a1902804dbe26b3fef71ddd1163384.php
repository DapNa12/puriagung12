...
<?php $__env->startSection('meta_description', 'Data statistik kependudukan Puri Agung Permai RW12. Jumlah warga, RT, dan data demografis lainnya.'); ?>
<?php $__env->startSection('og_title', 'Statistik Kependudukan - Puri Agung Permai RW12'); ?>
<?php $__env->startSection('og_description', 'Data statistik kependudukan Puri Agung Permai RW12.'); ?>
...
<div class="rw-page-head border-b border-slate-200/80">
    <div class="max-w-7xl mx-auto px-4 py-12 md:py-16">
        <div class="max-w-3xl">
            ...
            <p class="mt-3 text-slate-600 text-base md:text-lg">Demografi kependudukan, kelompok usia, agama, pendidikan, golongan darah, dan sebaran wilayah <?php echo e($selectedRt ? 'RT ' . sprintf('%02d', $selectedRt) : 'RW 12'); ?>.</p>
        </div>
    </div>
</div>
...
<div class="max-w-7xl mx-auto px-4 py-10 space-y-8">
    <!-- Filter Bar per RT -->
    <form method="GET" action="<?php echo e(route('statistik')); ?>" class="bg-white p-4 md:p-5 rounded-2xl border border-slate-200 shadow-sm flex flex-col md:flex-row gap-4 items-center justify-between">
        ...
        <div class="flex items-center gap-3 w-full md:w-auto">
            <select name="rt" onchange="this.form.submit()" class="w-full md:w-64 bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-sm font-semibold text-slate-700 focus:outline-none focus:border-rose-500 focus:bg-white transition-all shadow-inner">
                ...
                <?php $__currentLoopData = $daftarRt; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rtItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($rtItem); ?>" <?php if($selectedRt == $rtItem): echo 'selected'; endif; ?>>RT <?php echo e(sprintf('%02d', $rtItem)); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
            <?php if($selectedRt): ?>
                <a href="<?php echo e(route('statistik')); ?>" class="px-3 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-600 rounded-xl text-xs font-bold transition-all whitespace-nowrap">
                    Reset Filter
                </a>
            <?php endif; ?>
        </div>
    ...
    <?php if($selectedRt): ?>
        <div class="bg-rose-50 border border-rose-200 rounded-xl p-4 flex items-center justify-between">
            <p class="text-sm font-medium text-rose-800">Menampilkan statistik khusus wilayah <span class="font-bold">RT <?php echo e(sprintf('%02d', $selectedRt)); ?></span></p>
            <a href="<?php echo e(route('statistik')); ?>" class="text-xs font-bold text-rose-600 hover:underline">Tampilkan Seluruh RW 12 &rarr;</a>
        </div>
    <?php endif; ?>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm hover:border-rose-300 transition-all">
            ...
            <p class="text-2xl font-extrabold text-slate-900 mt-1"><span data-count="<?php echo e($jumlahRumah); ?>">0</span></p>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm hover:border-rose-300 transition-all">
            ...
            <p class="text-2xl font-extrabold text-slate-900 mt-1"><span data-count="<?php echo e($totalWarga); ?>">0</span></p>
            <p class="text-xs text-slate-500 mt-0.5">Jiwa Terdaftar <?php echo e($selectedRt ? 'RT ' . sprintf('%02d', $selectedRt) : ''); ?></p>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm hover:border-rose-300 transition-all">
            ...
            <p class="text-2xl font-extrabold text-slate-900 mt-1"><span data-count="<?php echo e($wargaLaki); ?>">0</span></p>
            <p class="text-xs text-slate-500 mt-0.5">Jiwa (<?php echo e($totalWarga > 0 ? round(($wargaLaki / $totalWarga) * 100) : 0); ?>%)</p>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm hover:border-rose-300 transition-all">
            ...
            <p class="text-2xl font-extrabold text-slate-900 mt-1"><span data-count="<?php echo e($wargaPerempuan); ?>">0</span></p>
            <p class="text-xs text-slate-500 mt-0.5">Jiwa (<?php echo e($totalWarga > 0 ? round(($wargaPerempuan / $totalWarga) * 100) : 0); ?>%)</p>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm hover:border-emerald-300 transition-all">
            ...
            <p class="text-2xl font-extrabold text-slate-900 mt-1"><?php echo e(count($wargaPerRt)); ?></p>
    ...
    <div id="content-usia" class="tab-content block">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-1 bg-white rounded-2xl border border-slate-200 p-6 shadow-sm flex flex-col items-center justify-center">
                <h3 class="text-base font-bold text-slate-900 mb-4 text-center">Grafik Kelompok Usia <?php echo e($selectedRt ? '(RT ' . sprintf('%02d', $selectedRt) . ')' : ''); ?></h3>
                <div class="w-full max-w-[260px] h-[260px] flex items-center justify-center">
                    <?php if($totalWarga > 0): ?>
                        <canvas id="chartUsia"></canvas>
                    <?php else: ?>
                        <div class="text-center text-slate-400 text-sm">
                            <p>Belum ada data warga <?php echo e($selectedRt ? 'di RT ini' : ''); ?></p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
                ...
                <div class="space-y-4">
                    <div>
                        <div class="flex justify-between text-sm font-semibold mb-1">
                            ...
                            <span class="text-slate-900 font-extrabold"><?php echo e($usiaBalita); ?> jiwa (<?php echo e($balitaPct); ?>%)</span>
                        </div>
                        <div class="w-full bg-slate-100 rounded-full h-3">
                            <div class="bg-amber-400 h-3 rounded-full transition-all duration-500" style="width: <?php echo e(max($balitaPct, $usiaBalita > 0 ? 3 : 0)); ?>%"></div>
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between text-sm font-semibold mb-1">
                            <span class="text-slate-700">Anak-anak (5-14 th)</span>
                            <span class="text-slate-900 font-extrabold"><?php echo e($usiaAnak); ?> jiwa (<?php echo e($anakPct); ?>%)</span>
                        </div>
                        <div class="w-full bg-slate-100 rounded-full h-3">
                            <div class="bg-rose-400 h-3 rounded-full transition-all duration-500" style="width: <?php echo e(max($anakPct, $usiaAnak > 0 ? 3 : 0)); ?>%"></div>
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between text-sm font-semibold mb-1">
                            <span class="text-slate-700">Remaja (15-24 th)</span>
                            <span class="text-slate-900 font-extrabold"><?php echo e($usiaRemaja); ?> jiwa (<?php echo e($remajaPct); ?>%)</span>
                        </div>
                        <div class="w-full bg-slate-100 rounded-full h-3">
                            <div class="bg-teal-500 h-3 rounded-full transition-all duration-500" style="width: <?php echo e(max($remajaPct, $usiaRemaja > 0 ? 3 : 0)); ?>%"></div>
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between text-sm font-semibold mb-1">
                            <span class="text-slate-700">Dewasa (25-59 th)</span>
                            <span class="text-slate-900 font-extrabold"><?php echo e($usiaDewasa); ?> jiwa (<?php echo e($dewasaPct); ?>%)</span>
                        </div>
                        <div class="w-full bg-slate-100 rounded-full h-3">
                            <div class="bg-indigo-600 h-3 rounded-full transition-all duration-500" style="width: <?php echo e(max($dewasaPct, $usiaDewasa > 0 ? 3 : 0)); ?>%"></div>
                        </div>
                    </div>
                    <div>
                        <div class="flex justify-between text-sm font-semibold mb-1">
                            <span class="text-slate-700">Lansia (&ge; 60 th)</span>
                            <span class="text-slate-900 font-extrabold"><?php echo e($usiaLansia); ?> jiwa (<?php echo e($lansiaPct); ?>%)</span>
                        </div>
                        <div class="w-full bg-slate-100 rounded-full h-3">
                            <div class="bg-rose-500 h-3 rounded-full transition-all duration-500" style="width: <?php echo e(max($lansiaPct, $usiaLansia > 0 ? 3 : 0)); ?>%"></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div id="content-agama" class="tab-content hidden">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-1 bg-white rounded-2xl border border-slate-200 p-6 shadow-sm flex flex-col items-center justify-center">
                <h3 class="text-base font-bold text-slate-900 mb-4 text-center">Grafik Agama <?php echo e($selectedRt ? '(RT ' . sprintf('%02d', $selectedRt) . ')' : ''); ?></h3>
                <div class="w-full max-w-[260px] h-[260px] flex items-center justify-center">
            ...
            <div class="lg:col-span-2 bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
                ...
                ?>
                <div class="space-y-4">
                    <?php $__currentLoopData = $listAgama; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $cnt = $statAgama[$agm] ?? 0;
                        ...
                        <div>
                            <div class="flex justify-between text-sm font-semibold mb-1">
                                <span class="text-slate-700"><?php echo e($agm); ?></span>
                                <span class="text-slate-900 font-extrabold"><?php echo e($cnt); ?> jiwa (<?php echo e($pct); ?>%)</span>
                            </div>
                            <div class="w-full bg-slate-100 rounded-full h-3">
                                <div class="bg-emerald-500 h-3 rounded-full transition-all duration-500" style="width: <?php echo e(max($pct, $cnt > 0 ? 3 : 0)); ?>%"></div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
    ...
    <div id="content-pendidikan" class="tab-content hidden">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-1 bg-white rounded-2xl border border-slate-200 p-6 shadow-sm flex flex-col items-center justify-center">
                <h3 class="text-base font-bold text-slate-900 mb-4 text-center">Grafik Pendidikan <?php echo e($selectedRt ? '(RT ' . sprintf('%02d', $selectedRt) . ')' : ''); ?></h3>
                <div class="w-full max-w-[260px] h-[260px] flex items-center justify-center">
            ...
            <div class="lg:col-span-2 bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <?php $__currentLoopData = $listPendidikan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pddk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div class="p-3 bg-slate-50 rounded-xl border border-slate-100">
                            <div class="flex justify-between text-sm font-semibold mb-1">
                                <span class="text-slate-700"><?php echo e($pddk); ?></span>
                                <span class="text-slate-900 font-extrabold"><?php echo e($cnt); ?> jiwa</span>
                            </div>
                            <div class="w-full bg-slate-200 rounded-full h-2 mt-2">
                                <div class="bg-rose-600 h-2 rounded-full transition-all duration-500" style="width: <?php echo e(max($pct, $cnt > 0 ? 5 : 0)); ?>%"></div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
    ...
    <div id="content-goldar" class="tab-content hidden">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div class="lg:col-span-1 bg-white rounded-2xl border border-slate-200 p-6 shadow-sm flex flex-col items-center justify-center">
                <h3 class="text-base font-bold text-slate-900 mb-4 text-center">Grafik Golongan Darah <?php echo e($selectedRt ? '(RT ' . sprintf('%02d', $selectedRt) . ')' : ''); ?></h3>
                <div class="w-full max-w-[260px] h-[260px] flex items-center justify-center">
            ...
            <div class="lg:col-span-2 bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    <?php $__currentLoopData = $listGoldar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gol): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $cnt = $statGoldar[$gol] ?? 0;
                            $pct = $totalWarga > 0 ? round(($cnt / $totalWarga) * 100, 1) : 0;
                        ?>
                        <div class="p-4 bg-rose-50/50 rounded-2xl border border-rose-100 text-center">
                            <span class="inline-flex items-center justify-center w-12 h-12 bg-rose-500 text-white font-extrabold rounded-xl text-lg mb-2 shadow-sm"><?php echo e($gol); ?></span>
                            <h4 class="text-2xl font-black text-slate-900"><?php echo e($cnt); ?> <span class="text-xs font-normal text-slate-500">jiwa</span></h4>
                            <p class="text-xs text-slate-500 mt-1 font-medium"><?php echo e($pct); ?>% dari total</p>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-slate-600">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        ?>
                        <?php $__empty_1 = true; $__currentLoopData = $wargaPerRt; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-slate-50 transition-colors <?php if($selectedRt == $row->rt): ?> bg-rose-50/70 font-semibold <?php endif; ?>">
                            <td class="px-6 py-3.5 font-bold text-slate-900">RT <?php echo e(sprintf('%02d', $row->rt)); ?></td>
                            <td class="px-6 py-3.5"><?php echo e(number_format($row->laki)); ?> jiwa</td>
                            <td class="px-6 py-3.5"><?php echo e(number_format($row->perempuan)); ?> jiwa</td>
                            <td class="px-6 py-3.5 font-extrabold text-slate-900"><?php echo e(number_format($row->total)); ?> jiwa</td>
                            <td class="px-6 py-3.5">
                                <div class="w-full bg-slate-100 rounded-full h-2">
                                    <div class="bg-rose-600 h-2 rounded-full" style="width: <?php echo e(($row->total / $maxRtTotal) * 100); ?>%"></div>
                                </div>
                            </td>
                            <td class="px-6 py-3.5">
                                <a href="<?php echo e(route('statistik', ['rt' => $row->rt])); ?>" class="inline-flex items-center gap-1 text-xs font-bold text-rose-600 hover:text-rose-800">
                                    Lihat Detail &rarr;
                                </a>
                            </td>
                        </tr>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        new Chart(document.getElementById('chartUsia'), {
            ...
            data: {
                ...
                datasets: [{
                    data: [<?php echo e($usiaBalita); ?>, <?php echo e($usiaAnak); ?>, <?php echo e($usiaRemaja); ?>, <?php echo e($usiaDewasa); ?>, <?php echo e($usiaLansia); ?>],
        ...
        new Chart(document.getElementById('chartAgama'), {
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        <?php echo e($statAgama['Islam'] ?? 0); ?>,
                        <?php echo e($statAgama['Kristen'] ?? 0); ?>,
                        <?php echo e($statAgama['Katolik'] ?? 0); ?>,
                        <?php echo e($statAgama['Budha'] ?? 0); ?>,
                        <?php echo e($statAgama['Hindu'] ?? 0); ?>,
                        <?php echo e($statAgama['Lainnya'] ?? 0); ?>
        ...
        new Chart(document.getElementById('chartPendidikan'), {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Jumlah Warga',
                    data: [
                        <?php echo e($statPendidikan['Belum Sekolah'] ?? 0); ?>,
                        <?php echo e($statPendidikan['SD'] ?? 0); ?>,
                        <?php echo e($statPendidikan['SMP'] ?? 0); ?>,
                        <?php echo e($statPendidikan['SMA'] ?? 0); ?>,
                        <?php echo e($statPendidikan['D1'] ?? 0); ?>,
                        <?php echo e($statPendidikan['D2'] ?? 0); ?>,
                        <?php echo e($statPendidikan['D3'] ?? 0); ?>,
                        <?php echo e($statPendidikan['S1'] ?? 0); ?>,
                        <?php echo e($statPendidikan['S2'] ?? 0); ?>,
                        <?php echo e($statPendidikan['S3'] ?? 0); ?>
        ...
        new Chart(document.getElementById('chartGoldar'), {
            ...
            data: {
                ...
                datasets: [{
                    data: [
                        <?php echo e($statGoldar['A'] ?? 0); ?>,
                        <?php echo e($statGoldar['B'] ?? 0); ?>,
                        <?php echo e($statGoldar['AB'] ?? 0); ?>,
                        <?php echo e($statGoldar['O'] ?? 0); ?>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\david\Downloads\web-rw12\web-rw12\web-rw12\resources\views\public\statistik.blade.php ENDPATH**/ ?>