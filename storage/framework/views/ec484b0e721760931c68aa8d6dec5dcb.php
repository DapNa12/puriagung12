...
<?php $__env->startSection('meta_description', 'Portal resmi Puri Agung Permai RW12, Kelurahan Gelam Jaya, Kecamatan Pasar Kemis, Kabupaten Tangerang. Informasi berita, pengumuman, kegiatan, dan layanan warga.'); ?>
<?php $__env->startSection('og_title', 'Puri Agung Permai RW12 - Beranda'); ?>
<?php $__env->startSection('og_description', 'Portal resmi Puri Agung Permai RW12. Informasi berita, pengumuman, kegiatan, dan layanan warga.'); ?>

<?php $__env->startSection('content'); ?>
<!-- Hero Section -->
<div class="relative bg-gradient-to-br from-rose-900 via-rose-800 to-teal-900 text-white overflow-hidden">
    <div class="absolute inset-0">
        <div class="hero-slide absolute inset-0 bg-cover bg-center opacity-0 transition-all duration-1000" style="background-image: url('<?php echo e(asset('images/hero/slide1.jpg')); ?>')"></div>
        <div class="hero-slide absolute inset-0 bg-cover bg-center opacity-0 transition-all duration-1000" style="background-image: url('<?php echo e(asset('images/hero/slide2.jpg')); ?>')"></div>
    </div>
    ...
    <div class="relative max-w-7xl mx-auto px-4 py-24 md:py-32 flex flex-col items-center text-center">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center w-full sm:w-auto">
            ...
            <a href="<?php echo e(route('kegiatan')); ?>" class="inline-flex items-center justify-center gap-2 bg-rose-700/50 hover:bg-rose-600/60 text-white border border-rose-500/30 backdrop-blur-md px-8 py-3.5 rounded-xl font-semibold transition-all duration-300 hover:border-rose-400/50 transform hover:-translate-y-1">
...
<div class="max-w-7xl mx-auto px-4 relative z-20 -mt-12 md:-mt-16 mb-20" data-aos="fade-up">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white/90 backdrop-blur-xl rounded-2xl shadow-xl shadow-slate-200/50 p-6 flex flex-col items-center border border-white transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-rose-200/50">
            ...
            <div class="text-4xl font-extrabold text-slate-900 mb-1"><span data-count="<?php echo e($totalWarga); ?>">0</span></div>
        ...
        <div class="bg-white/90 backdrop-blur-xl rounded-2xl shadow-xl shadow-slate-200/50 p-6 flex flex-col items-center border border-white transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-rose-200/50" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="text-4xl font-extrabold text-slate-900 mb-1"><span data-count="<?php echo e($pengumuman->count()); ?>">0</span></div>
        ...
        <div class="bg-white/90 backdrop-blur-xl rounded-2xl shadow-xl shadow-slate-200/50 p-6 flex flex-col items-center border border-white transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-amber-200/50" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="text-4xl font-extrabold text-slate-900 mb-1"><span data-count="<?php echo e($kegiatan->count()); ?>">0</span></div>
...
<div class="max-w-7xl mx-auto px-4 pb-20" data-aos="fade-up">
    ...
    <div class="mb-20" data-aos="fade-up">
        <div class="flex items-center justify-between mb-8">
            ...
            <a href="<?php echo e(route('pengumuman')); ?>" class="hidden sm:inline-flex items-center gap-1 text-rose-600 font-medium hover:text-rose-700 hover:underline">
                Lihat Semua
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php $__currentLoopData = $pengumuman->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('pengumuman.show', $item)); ?>" class="group bg-white rounded-2xl shadow-sm border border-slate-100 hover:shadow-xl hover:border-rose-100 hover:-translate-y-1 transition-all duration-300 flex flex-col h-full overflow-hidden">
                ...
                <div class="p-6 flex flex-col flex-1">
                    <div class="flex items-center gap-2 text-xs font-medium text-slate-400 mb-4">
                        <span class="bg-slate-100 text-slate-600 px-2.5 py-1 rounded-md"><?php echo e($item->created_at->isoFormat('D MMM Y')); ?></span>
                        <span>&bull;</span>
                        <span>Puri Agung</span>
                    </div>
                    <h3 class="text-xl font-bold text-slate-900 mb-3 group-hover:text-rose-700 transition-colors line-clamp-2"><?php echo e($item->judul); ?></h3>
                    <p class="text-slate-500 text-sm leading-relaxed mb-6 flex-1 line-clamp-3"><?php echo e(Str::limit($item->isi, 120)); ?></p>
    ...
    <div data-aos="fade-up">
        <div class="flex items-center justify-between mb-8">
            ...
            <a href="<?php echo e(route('kegiatan')); ?>" class="hidden sm:inline-flex items-center gap-1 text-rose-600 font-medium hover:text-rose-700 hover:underline">
                Lihat Semua
                <i data-lucide="chevron-right" class="w-4 h-4"></i>
            </a>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <?php $__currentLoopData = $kegiatan->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden flex flex-col sm:flex-row hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                <div class="sm:w-48 h-48 sm:h-auto shrink-0 bg-slate-100 relative overflow-hidden">
                    <?php if($item->foto): ?>
                    <img src="<?php echo e(asset('storage/'.$item->foto)); ?>" alt="<?php echo e($item->nama_kegiatan); ?>" class="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-500">
                    <?php else: ?>
                    ...
                    <div class="absolute top-3 left-3 bg-white/90 backdrop-blur-sm px-3 py-1.5 rounded-lg shadow-sm text-center">
                        <div class="text-xs font-bold text-slate-500 uppercase"><?php echo e(\Carbon\Carbon::parse($item->tanggal)->isoFormat('MMM')); ?></div>
                        <div class="text-xl font-extrabold text-slate-900 leading-none"><?php echo e(\Carbon\Carbon::parse($item->tanggal)->format('d')); ?></div>
                    </div>
                </div>
                <div class="p-6 flex flex-col justify-center flex-1">
                    <h3 class="text-xl font-bold text-slate-900 mb-3 group-hover:text-rose-700 transition-colors"><?php echo e($item->nama_kegiatan); ?></h3>
                    <div class="space-y-2 text-sm text-slate-600">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span class="line-clamp-1"><?php echo e($item->tempat); ?></span>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\david\Downloads\web-rw12\web-rw12\web-rw12\resources\views\public\home.blade.php ENDPATH**/ ?>