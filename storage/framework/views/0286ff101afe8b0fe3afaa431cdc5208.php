    ...
    <div class="bg-white rounded-2xl border border-slate-200 p-6">
        <form method="POST" action="<?php echo e(route('admin.users.update', $user->id)); ?>" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="name" value="<?php echo e(old('name', $user->name)); ?>" required class="input-field <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="email" name="email" value="<?php echo e(old('email', $user->email)); ?>" required class="input-field <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> input-error <?php unset($message);
            ...
            <div class="p-4 bg-amber-50 rounded-xl border border-amber-200">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-3">
                    <div>
                        ...
                        <input type="password" name="password" class="input-field bg-white <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> input-error <?php unset($message);
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <select name="role" required class="input-field">
                        ...
                        <option value="sekretaris" <?php echo e(old('role', $user->role) == 'sekretaris' ? 'selected' : ''); ?>>Sekretaris</option>
                        <option value="ketua_rw" <?php echo e(old('role', $user->role) == 'ketua_rw' ? 'selected' : ''); ?>>Ketua RW</option>
                    </select>
                </div>
                <div>
                    ...
                    <select name="is_active" required class="input-field">
                        ...
                        <option value="0" <?php echo e(old('is_active', $user->is_active) == 0 ? 'selected' : ''); ?>>Non-Aktif</option>
                    </select>
                </div>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\david\Downloads\web-rw12\web-rw12\web-rw12\resources\views\admin\users\edit.blade.php ENDPATH**/ ?>