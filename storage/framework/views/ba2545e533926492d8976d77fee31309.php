<?php $__env->startSection('title', 'Edit UMKM - ' . $umkm->nama); ?>
...
<div class="flex items-center gap-4 mb-6">
    ...
    <div>
        <h1 class="text-2xl font-bold text-slate-900">Edit UMKM</h1>
        <p class="text-sm text-slate-500"><?php echo e($umkm->nama); ?></p>
    </div>
</div>

<div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 max-w-2xl">
    <form action="<?php echo e(route('admin.umkm.update', $umkm->id)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div class="md:col-span-2">
                ...
                <input type="text" name="nama" value="<?php echo e(old('nama', $umkm->nama)); ?>" placeholder="Nama usaha / toko" class="input-field <?php $__errorArgs = ['nama'];
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <option value="<?php echo e($kat); ?>" <?php if(old('kategori', $umkm->kategori)==$kat): echo 'selected'; endif; ?>><?php echo e($kat); ?></option>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="nama_pemilik" value="<?php echo e(old('nama_pemilik', $umkm->nama_pemilik)); ?>" placeholder="Nama pemilik usaha" class="input-field <?php $__errorArgs = ['nama_pemilik'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('deskripsi', $umkm->deskripsi)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="alamat" value="<?php echo e(old('alamat', $umkm->alamat)); ?>" placeholder="Alamat usaha" class="input-field <?php $__errorArgs = ['alamat'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="rt" list="rt-list" value="<?php echo e(old('rt', $umkm->rt)); ?>" placeholder="Contoh: 001" maxlength="3" class="input-field <?php $__errorArgs = ['rt'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="no_hp" value="<?php echo e(old('no_hp', $umkm->no_hp)); ?>" placeholder="08xxxxxxxxxx" class="input-field <?php $__errorArgs = ['no_hp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="text" name="jam_operasional" value="<?php echo e(old('jam_operasional', $umkm->jam_operasional)); ?>" placeholder="Contoh: 08.00 - 17.00" class="input-field <?php $__errorArgs = ['jam_operasional'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="md:col-span-2">
                ...
                <input type="url" name="maps_link" value="<?php echo e(old('maps_link', $umkm->maps_link)); ?>" placeholder="https://maps.app.goo.gl/..." class="input-field <?php $__errorArgs = ['maps_link'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="md:col-span-2">
                ...
                <?php if($umkm->foto): ?>
                <div class="mb-2">
                    <img src="<?php echo e(asset('storage/'.$umkm->foto)); ?>" alt="<?php echo e($umkm->nama); ?>" class="w-24 h-24 rounded-lg object-cover">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="md:col-span-2">
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="is_active" value="1" <?php echo e(old('is_active', $umkm->is_active) ? 'checked' : ''); ?> class="w-4 h-4 text-rose-600 rounded border-slate-300">
                    <span class="text-sm font-medium text-slate-700">Aktifkan (tampilkan di halaman public)</span>
                </label>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\david\Downloads\web-rw12\web-rw12\web-rw12\resources\views\admin\umkm\edit.blade.php ENDPATH**/ ?>